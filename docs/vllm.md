...
Инференс GLiNER Guard через [vLLM](https://github.com/vllm-project/vllm) с использованием плагина `deberta_gliner2` из [vllm-factory](https://github.com/ddickmann/vllm-factory).
...
- **Модель:** `hivetrace/gliner-guard-uniencoder` (GLiNER2 + DeBERTa backbone)
...
# 2. Установить vllm-factory с зависимостями GLiNER
cd vllm-factory
pip install -e ".[gliner]"

# 3. Установить vLLM (ПОСЛЕДНИМ — фиксирует зависимости)
pip install vllm

# 4. Установить зависимости Locust-тестов
cd ../test-script
