...
Источник: `results/vllm/gliner-guard_v3`

| Experiment | RPS | P50 (ms) | P95 (ms) | P99 (ms) | Err rate (%) |
|---|---:|---:|---:|---:|---:|
| litserve-baseline | **150.1** | **560** | 1400 | 1500 | 0.00 |
| single-safe | 86.9 | 1100 | 1400 | 1500 | 0.00 |
| single-dense | 70.0 | 1500 | 1800 | 1900 | 0.00 |
| single-short | 67.2 | 1600 | 1800 | 1900 | 0.00 |
| multi-2x | 103.3 | 1000 | 1100 | 1200 | 0.00 |
| multi-4x | 139.7 | 720 | **780** | **820** | 0.00 |

Короткий вывод:
- лучший throughput: `litserve-baseline`
- лучший p95: `multi-4x`
