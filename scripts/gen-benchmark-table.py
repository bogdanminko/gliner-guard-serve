...
RUNTIME_ORDER = [
    ...
    "onnx-cuda-fp16", "onnx-trt-fp16", "onnx-int8-cpu",
    "bfloat16-eager", "float16-eager",
    "bfloat16-cudagraph", "float16-cudagraph",
    "bfloat16-eager-batch16k", "bfloat16-eager-batch4k",
