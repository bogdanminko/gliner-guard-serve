...
#
# Usage:
#   ./serve.sh                          # defaults: float16, CUDA graphs enabled
#   VLLM_DTYPE=bfloat16 ./serve.sh      # override dtype
#   VLLM_EXTRA_FLAGS="--enforce-eager" ./serve.sh  # eager fallback
#
...
#   VLLM_DTYPE         dtype                (default: float16)
